      ...
      payload: {
        ...
        lookups: { formData:[
            {"id":"http://id.loc.gov/ontologies/bibframe/issuance",
              "items":[{"id":"http://id.loc.gov/vocabulary/issuance/mono",
                  "uri":"http://id.loc.gov/vocabulary/issuance/mono",
                  "label":"single unit"}],
              "rtId":"resourceTemplate:bf2:Monograph:Instance"},
            {"id":"http://id.loc.gov/ontologies/bibframe/carrier",
              "items":[{"id":"http://id.loc.gov/vocabulary/carriers/nc",
    ...
    let action = {type: "GENERATE_LD",
      ...
      literals:{ formData:[
        {"id":"http://id.loc.gov/ontologies/bibframe/responsibilityStatement",
          "rtId":"resourceTemplate:bf2:Monograph:Instance",
          "items":[{"content":"STATEMENT","id":0,"bnode":{"termType":"BlankNode","value":"n3-7"}}]},
        {"id":"http://id.loc.gov/ontologies/bibframe/heldBy",
          "rtId":"resourceTemplate:bf2:Monograph:Instance",
          "items":[{"content":"STF","id":0,"bnode":{"termType":"BlankNode","value":"n3-10"}}]},
        {"id":"http://www.w3.org/2000/01/rdf-schema#label",
          "rtId":"resourceTemplate:bf2:Note",
          "items":[{"content":"NOTE","id":0,"type":"http://id.loc.gov/ontologies/bibframe/note","bnode":{"termType":"BlankNode","value":"n3-14"}}]}]},
        lookups:{ formData:[
          {"id":"http://id.loc.gov/ontologies/bibframe/issuance",
            "items":[],"rtId":"resourceTemplate:bf2:Monograph:Instance"},
          {"id":"http://id.loc.gov/ontologies/bibframe/carrier","items":[],
            "rtId":"resourceTemplate:bf2:Monograph:Instance"}]},
        rtId: "resourceTemplate:bf2:Monograph:Instance",
        resourceURI: "http://id.loc.gov/ontologies/bibframe/Instance",
        linkedNode: {"termType":"BlankNode","value":"n3-0"}
