...
describe('getting property related info from a resource', () => {
  it('has tooltip text info or a link based on the content of a top-level property remark', async () => {
    ...
    const infoIcon3 = await screen.findByRole('link', { name: 'Uber template3, property1' })
  ...
  it('has tooltip text info based on the content of a nested property remark', async () => {
    ...
    const infoIcon1 = await screen.findByRole('link', { name: 'Uber template1, property18' })
    ...
    const nestedInfoIcons = await screen.findAllByRole('link', { name: 'Uber template4, property1' })
