    ...
    function getForm (loadTemplates, pt) {
      ...
      for (var urt = 0; urt < loadTemplates.length; urt++) {
        ...
        if (rt !== undefined && rt[0] !== undefined) {
          ...
          bfelog.addMsg(new Error(), 'WARN', `Unable to locate resourceTemplate. Verify the resourceTemplate ID is correct for ${loadTemplates[urt].resourceTemplateID} at ${loadTemplates[urt].defaulturi}`);
        }
      }
